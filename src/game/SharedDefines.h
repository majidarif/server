...
enum SpellCastResultCustom
{
    ...
    SPELL_FAILED_CUSTOM_ERROR_6         = 6,                // "You can not target friendly targets outside your party."
    ...
    SPELL_FAILED_CUSTOM_ERROR_10        = 10,               // "You can not summon another gargoyle yet."
    ...
    SPELL_FAILED_CUSTOM_ERROR_36        = 36,               // "You can not target an elemental or mechanical corpse."
    SPELL_FAILED_CUSTOM_ERROR_37        = 37,               // "This teleport crystal can not be used until the teleport crystal in Dalaran has been used at least once."
    ...
    SPELL_FAILED_CUSTOM_ERROR_42        = 42,               // "You can not build any more siege vehicles."
