mangos-three, a World of Warcraft server for cataclysm WoW  [![Build status](https://travis-ci.org/mangosthree/server.png)][16]
=======================================================
...
cataclysm versions, namely [patch 4.3.4][4].
...
Requirements
------------
*mangos-three* server supports a wide range of operating systems, and various
...
Operating systems
-----------------
Currently we do support running *mangos-three* on these operating systems:
...
Compilers
---------
Building *mangos-three* is currently possible with these compilers:
...
Dependencies
------------
*mangos-three* server stands on the shoulders of well-known Open Source
...
*Recast*, *G3D* and *libmpq* are included in the *mangos-three* distribution as
...
* **Doxygen**: if you want to export HTML or PDF formatted documentation for the
  *mangos-three* API, you should install [Doxygen][49].
* **Lua**: if you want to test drive how *mangos-three* feels with [Lua][50] as
  scripting language instead of the scripting library, you will need Lua **5.1.x**
  installed.

Discuss
-------
If you need help with building and installing *mangos-three* there is thousands
of users out there already running *mangos-three* and many you can find on
...
*mangos-three* with the OpenSSL project's [OpenSSL library][48] (or with modified
...
[^2]: Clang support for Windows is experimental. Failure to compile mangos-three
...
[12]: http://github.com/mangoszero "mangos-three · github organization"
...
[16]: https://travis-ci.org/mangoszero/server "Travis CI · mangos-three build status"
